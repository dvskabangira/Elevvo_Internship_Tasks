...
# Load model
model = load_model('/workspaces/Elevvo_Internship_Tasks/Task4_Traffic sign recognition/traffic_classifier1.h5')
...
iface = gr.Interface(
    ...
    outputs=gr.Textbox(label="Predicted Traffic Sign"),
    title="Traffic Sign Classifier",
    description="Upload a traffic sign image and classify it."
)
